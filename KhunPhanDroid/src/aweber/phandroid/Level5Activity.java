...
public class Level5Activity extends GameActivity {
	...
	public static final String PROP_BEST = "best5"; // property where to store best solution of Level 5
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		((TextView)findViewById(R.id.txt_moves5)).setTypeface(Assets.ttf);
		((TextView)findViewById(R.id.txt_best_solution5)).setTypeface(Assets.ttf);
	}
