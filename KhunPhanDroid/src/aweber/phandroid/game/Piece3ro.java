...
// XX
//  X
public class Piece3ro extends Piece {

	// PX
	//  X
	public Piece3ro(int xLeft, int yTop) {
		super(xLeft, yTop);
	}
	...
	protected boolean canMoveLeft(BoardPos free1, BoardPos free2) {
		if ((free1.equalPos(xLeft - 1, yTop) && free2.equalPos(xLeft, yTop + 1))
				|| (free2.equalPos(xLeft - 1, yTop) && free1.equalPos(xLeft, yTop + 1))) {
			return true;
		}
		return false;
	}
	...
	protected boolean canMoveDown(BoardPos free1, BoardPos free2) {
		if ((free1.equalPos(xLeft, yTop + 1) && free2.equalPos(xLeft + 1, yTop + 2))
				|| (free2.equalPos(xLeft, yTop + 1) && free1.equalPos(xLeft + 1, yTop + 2))) {
			return true;
		}
		return false;
	}
